...
class _SettingsScreenState extends State<SettingsScreen> {
  ...
  Future<void> _saveSettings() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(_t('Settings saved!', 'Settings berhasil disimpan!')),
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text(
                        _t(
                          ...
                          'Nonaktifkan notifikasi otomatis yang tidak kamu inginkan. Pengumuman admin tetap akan dikirim.',
                        ),
                        style: TextStyle(
                          fontSize: 12,
                          height: 1.4,
                    ...
                    _buildNotificationToggle(
                      _t('Likes', 'Like'),
                      _t(
                        'Notify when someone likes my recipe',
                        'Beri tahu saat seseorang menyukai resep saya',
                      ),
                      'notify_likes',
                      isDarkMode,
                    ),
                    _buildNotificationToggle(
                      _t('Comments', 'Komentar'),
                      _t(
                        'Notify when someone comments on my recipe',
                        'Beri tahu saat seseorang mengomentari resep saya',
                      ),
                      'notify_comments',
                      isDarkMode,
                    ),
                    _buildNotificationToggle(
                      ...
                      _t(
                        ...
                        'Beri tahu saat seseorang mengikuti saya',
                      ),
                      'notify_follows',
                      isDarkMode,
                    ),
                    _buildLockedNotificationTile(isDarkMode),
  ...
  Widget _buildLockedNotificationTile(bool isDarkMode) {
    return _buildSettingTile(
      title: _t('Admin Announcements', 'Pengumuman Admin'),
      subtitle: _t(
        'Always active for important Savora updates',
        'Selalu aktif untuk pembaruan penting Savora',
      ),
      trailing: Icon(
        Icons.lock_rounded,
