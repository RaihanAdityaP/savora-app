  ...
  Widget _buildIPSection() {
    ...
    return Container(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          // FIX: Header row restructured to prevent overflow
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 6),
                        // FIX: Expanded wraps title text instead of overflowing
                        const Expanded(
                          child: Text(
                    ...
                    // FIX: Badge moved below title, no longer competes for horizontal space
                    Align(
            ...
            child: RichText(
              text: TextSpan(
                ...
                children: [
                  ...
                  const TextSpan(
                      text:
                          ' atas pelanggaran hak cipta, merek dagang, atau hak kekayaan intelektual lainnya yang dilakukan oleh pengguna.'),
                ],
              ),
            ),
          ),
  ...
  Widget _buildLiabilitySection() {
    ...
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text(
          'Savora bertindak sebagai platform berbagi resep dan TIDAK bertanggung jawab atas:',
          style: TextStyle(fontSize: 13, color: Colors.grey.shade700),
        ),
        const SizedBox(height: 8),
        ...items.map((item) => Container(
    ...
    final sections = [
      {
        ...
        'text':
            'Savora berhak untuk meninjau, menyetujui, menolak, atau menghapus konten yang dianggap melanggar syarat dan ketentuan ini tanpa pemberitahuan sebelumnya.'
      },
      {
        'num': '7',
        'color': Colors.purple,
        'title': 'Akun Pengguna',
        'text':
            'Anda bertanggung jawab untuk menjaga kerahasiaan akun dan password Anda. Savora tidak bertanggung jawab atas kerugian yang timbul dari akses tidak sah ke akun Anda.'
      },
      {
        'num': '8',
        'color': Colors.pink,
        ...
        'text':
            'Savora berhak untuk menangguhkan atau menghentikan akses Anda ke platform jika terbukti melanggar syarat dan ketentuan ini, tanpa kompensasi apapun.'
      },
      {
        'num': '9',
        'color': Colors.indigo,
        ...
        'text':
            'Savora berhak untuk mengubah syarat dan ketentuan ini sewaktu-waktu. Perubahan akan berlaku segera setelah dipublikasikan di platform.'
      },
      {
        'num': '10',
        ...
        'text':
            'Syarat dan ketentuan ini diatur oleh dan ditafsirkan sesuai dengan hukum Republik Indonesia. Setiap sengketa akan diselesaikan di pengadilan yang berwenang di Indonesia.'
      },
    ];
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      const TextSpan(
                          text:
                              ' dari segala tuntutan hukum terkait konten yang diunggah oleh pengguna, termasuk namun tidak terbatas pada pelanggaran hak cipta, cedera, atau kerugian material.'),
                    ],
                  ),
                ),
              ],
      ...
      children: [
        Row(
          children: [
            ...
            const SizedBox(width: 12),
            // FIX: Expanded prevents section titles from overflowing
            Expanded(
              child: Text(
                title,
                style: const TextStyle(
