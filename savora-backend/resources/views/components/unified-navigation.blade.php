                        ...
                        <div x-show="showProfileMenu"
                            ...
                            <a :href="profileUrl()" @click="showProfileMenu = false"
                               class="flex items-center gap-3 px-4 py-3 border-b border-gray-100 hover:bg-gray-50 transition-colors">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500">Lihat profile</p>
                                </div>
                            </a>
                            ...
                            @php
                                $menuItems = [
                                    ...
                                    ['label' => 'Profile',    'route' => null,                 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'dynamic' => true],
                                ];
                            @endphp
        ...
        <div class="flex items-end justify-between px-4 py-1" style="padding-bottom: env(safe-area-inset-bottom, 4px)">
            ...
            <a href="{{ route('app.search') }}"
               class="flex flex-col items-center gap-0.5 flex-1 py-1.5 active:scale-95 transition-transform">
                ...
                <span class="text-[10px] font-semibold {{ request()->routeIs('app.search') ? 'text-[#E76F51]' : 'text-gray-400' }}">Search</span>
            </a>
            ...
            <a href="{{ route('app.favorites') }}"
               class="flex flex-col items-center gap-0.5 flex-1 py-1.5 active:scale-95 transition-transform">
                ...
                <span class="text-[10px] font-semibold {{ request()->routeIs('app.favorites*') ? 'text-[#E76F51]' : 'text-gray-400' }}">Saved</span>
            </a>
            ...
            <div class="relative flex-1">
                <button @click.stop="showMobileMenu = !showMobileMenu"
                    ...
                    <span class="text-[10px] font-semibold {{ request()->routeIs('app.profile*') ? 'text-[#E76F51]' : 'text-gray-400' }}">Profil</span>
                </button>
