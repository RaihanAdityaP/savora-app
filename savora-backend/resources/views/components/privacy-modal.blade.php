    ...
    >
        ...
        <div style="background: linear-gradient(135deg, #2A9D8F, #264653, #1a5c54); position: relative; overflow: hidden;" class="px-8 py-6 text-white flex-shrink-0">
            ...
            <div class="flex items-center gap-4 relative">
                ...
                <div class="flex-1">
                    <h2 class="text-2xl font-black text-white">Privacy Policy</h2>
                    <p class="text-sm font-medium" style="color:rgba(255,255,255,0.85);">Protecting your data is our priority</p>
                </div>
                <button 
                    @click="close()"
            ...
            <div class="space-y-5 text-sm leading-relaxed">
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Information We Collect</h3>
                    </div>
                    <p class="text-gray-500 mb-3">We collect the following information when you use Savora:</p>
                    <div class="space-y-2">
                        @foreach([
                            ['icon' => 'person', 'title' => 'Account Information', 'desc' => 'Email, username, full name, profile photo'],
                            ['icon' => 'visibility', 'title' => 'Content', 'desc' => 'Recipes, photos, videos, comments, and reviews you upload'],
                            ['icon' => 'share', 'title' => 'Activity', 'desc' => 'Recipes you save, follow activity, and ratings you submit'],
                            ['icon' => 'storage', 'title' => 'Technical Data', 'desc' => 'IP address, browser, device, and activity logs'],
                            ['icon' => 'cookie', 'title' => 'Cookies', 'desc' => 'Data used to keep login sessions and preferences'],
                        ] as $item)
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Use of Information</h3>
                    </div>
                    <p class="text-gray-500 mb-3">We use the information we collect to:</p>
                    <div class="space-y-2">
                        @foreach([
                            'Provide and improve the platform',
                            'Process authentication and account security',
                            'Show relevant and personalized content',
                            'Send notifications related to account activity',
                            'Analyze platform usage for improvements',
                            'Prevent abuse and illegal activity',
                ...
                <!-- Section 3: Information Sharing (NOT SOLD) -->
                <section style="background:linear-gradient(135deg, #f0fdf4, rgba(240,253,244,0.5));border:2px solid #86efac;border-radius:16px;" class="p-5">
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base flex-1">Information Sharing</h3>
                        <span style="background:#22c55e;color:white;font-size:10px;font-weight:bold;padding:3px 10px;border-radius:20px;">NOT SOLD</span>
                    </div>
                    <div style="background:#dcfce7;border-radius:8px;" class="px-3 py-2 mb-3">
                        <p class="font-bold text-xs" style="color:#14532d;">We do NOT sell your personal data.</p>
                    </div>
                    <p class="text-gray-500 text-xs mb-3">Your information may be shared in the following situations:</p>
                    <div class="space-y-2">
                        @foreach([
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Data Security</h3>
                    </div>
                    <p class="text-gray-500 text-xs leading-relaxed">We apply reasonable security measures to protect your data, including encryption, access controls, and security monitoring. However, no system is 100% secure from cyberattacks. You are responsible for keeping your account password and API keys confidential.</p>
                </section>
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">User Rights</h3>
                    </div>
                    <p class="text-gray-500 text-xs mb-3">You have the right to:</p>
                    <div class="space-y-2">
                        @foreach([
                            ['num' => '1', 'title' => 'Access', 'desc' => 'View the personal data we store'],
                            ['num' => '2', 'title' => 'Correction', 'desc' => 'Update inaccurate information'],
                            ['num' => '3', 'title' => 'Deletion', 'desc' => 'Delete your account and personal data'],
                            ['num' => '4', 'title' => 'Portability', 'desc' => 'Download your data in a structured format'],
                            ['num' => '5', 'title' => 'Objection', 'desc' => 'Object to certain data processing'],
                        ] as $item)
                    ...
                    <p class="text-gray-400 text-xs italic mt-2">To exercise these rights, contact us by email or through the platform contact feature.</p>
                </section>
                ...
                <section style="background:linear-gradient(135deg, #fff7ed, #fffbeb);border:2px solid #fdba74;border-radius:16px;" class="p-5">
                    <div class="flex items-start gap-3 mb-4">
                        ...
                        <div class="flex-1">
                            <h3 class="font-bold text-gray-800" style="font-size:15px;">Third-Party AI Proxy Usage</h3>
                        </div>
                        <span style="background:#ea580c;color:white;font-size:10px;font-weight:bold;padding:3px 10px;border-radius:20px;flex-shrink:0;">IMPORTANT</span>
                    </div>
                    <p class="text-gray-600 text-xs leading-relaxed mb-4">Savora provides an optional feature to connect third-party AI services (such as OpenRouter) through proxy settings. By using this feature, you understand and agree to the following:</p>
                    <div class="space-y-3">
                        <!-- Item A -->
                        <div style="background:rgba(255,255,255,0.85);border:1px solid #fdba74;border-radius:10px;" class="p-3 flex items-start gap-3">
                            ...
                            <div>
                                <p class="font-bold text-xs text-red-600">No Payment Responsibility</p>
                                <p class="text-gray-600 text-xs mt-1 leading-relaxed">Savora is not responsible for any costs, charges, or payments arising from the use of third-party AI services. Users are fully responsible for managing credits, quotas, and fees charged by the selected provider.</p>
                            </div>
                        </div>
                        <!-- Item B -->
                        <div style="background:rgba(255,255,255,0.85);border:1px solid #fdba74;border-radius:10px;" class="p-3 flex items-start gap-3">
                            ...
                            <div>
                                <p class="font-bold text-xs text-purple-600">No Official Relationship</p>
                                <p class="text-gray-600 text-xs mt-1 leading-relaxed">Savora has no partnership, affiliation, cooperation, or official relationship with third-party AI services configurable through this feature, including but not limited to OpenRouter and other providers. Third-party names and logos are shown only as user references.</p>
                            </div>
                        </div>
                        <!-- Item C -->
                        <div style="background:rgba(255,255,255,0.85);border:1px solid #fdba74;border-radius:10px;" class="p-3 flex items-start gap-3">
                            ...
                            <div>
                                <p class="font-bold text-xs text-orange-700">User Risk Consent</p>
                                <p class="text-gray-600 text-xs mt-1 leading-relaxed">By enabling and using the third-party AI proxy feature, you explicitly accept all risks that may arise, including API key security risks, service unavailability, provider policy changes, and financial consequences from using paid models.</p>
                            </div>
                        </div>
                        <!-- Item D -->
                        <div style="background:rgba(255,255,255,0.85);border:1px solid #fdba74;border-radius:10px;" class="p-3 flex items-start gap-3">
                            ...
                            <div>
                                <p class="font-bold text-xs text-blue-600">Data Transfer to Third Parties</p>
                                <p class="text-gray-600 text-xs mt-1 leading-relaxed">When using a third-party proxy, messages and content you send will be forwarded to the relevant provider's servers. Savora cannot guarantee how that data is processed, stored, or used by third parties. Please read the provider's privacy policy before using it.</p>
                            </div>
                        </div>
                    </div>
                    <!-- Info Banner -->
                    <div style="background:#ffedd5;border:1px solid #fdba74;border-radius:10px;" class="p-3 mt-4 flex items-start gap-2">
                        ...
                        <p class="text-xs leading-relaxed" style="color:#9a3412;">This feature is optional. Savora provides Groq as the default free AI service managed by the server without additional user configuration.</p>
                    </div>
                </section>
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Data Retention</h3>
                    </div>
                    <p class="text-gray-500 text-xs leading-relaxed">We retain your data while your account is active and for a reasonable period afterward for legal and security purposes. Data that is no longer needed will be deleted periodically.</p>
                </section>
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Cookies and Tracking Technologies</h3>
                    </div>
                    <p class="text-gray-500 text-xs leading-relaxed">We use cookies to maintain login sessions, remember preferences, and analyze platform usage. You can configure your browser to reject cookies, but some features may not work properly.</p>
                </section>
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Children's Privacy</h3>
                    </div>
                    <p class="text-gray-500 text-xs leading-relaxed">This platform is not intended for children under 13. We do not knowingly collect personal data from children. If we become aware of children's data, we will delete it promptly.</p>
                </section>
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Policy Changes</h3>
                    </div>
                    <p class="text-gray-500 text-xs leading-relaxed">We may update this privacy policy from time to time. Significant changes will be communicated through email or platform notifications. Continued use of the platform after changes means you accept the updated policy.</p>
                </section>
                ...
                <section>
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <h3 class="font-bold text-gray-900 text-base">Contact</h3>
                    </div>
                    <p class="text-gray-500 text-xs mb-3">If you have questions about this privacy policy, please contact us:</p>
                    <div class="space-y-2">
                        ...
                        <div style="background:rgba(42,157,143,0.08);border-radius:10px;" class="p-3 flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <a href="https://savora-app.up.railway.app" target="_blank" rel="noopener noreferrer" class="font-semibold text-sm flex items-center gap-1 hover:underline" style="color:#2A9D8F;">
                                    savora-app.up.railway.app
                ...
                <section style="background:linear-gradient(135deg, #eff6ff, #ecfeff);border:2px solid #93c5fd;border-radius:16px;" class="p-5 flex items-start gap-4">
                    ...
                    <div>
                        <p class="font-bold text-sm" style="color:#1e3a8a;">Our Commitment</p>
                        <p class="text-xs mt-1 leading-relaxed" style="color:#1d4ed8;">We are committed to protecting your privacy and using your data responsibly under applicable Indonesian law.</p>
                    </div>
                </section>
