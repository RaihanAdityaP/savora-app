...
<head>
    ...
    <title>{{ $isEnglish ? '404 - Page Not Found' : '404 - Halaman Tidak Ditemukan' }} | Savora</title>
...
<body>
    ...
    <div class="error-card">
        ...
        <h1 class="error-title">{{ $isEnglish ? 'Page Not Found' : 'Halaman Tidak Ditemukan' }}</h1>
        <p class="error-subtitle">
            {{ $isEnglish ? 'The recipe you are looking for may have been moved, deleted, or never existed.' : 'Sepertinya resep yang kamu cari sudah dipindahkan, dihapus, atau memang tidak pernah ada.' }}<br>
            {{ $isEnglish ? 'Go back and explore more recipes!' : 'Yuk kembali dan jelajahi ribuan resep lainnya!' }}
        </p>
