...
<head>
    ...
    <title>{{ $isEnglish ? '429 - Too Many Requests' : '429 - Terlalu Banyak Permintaan' }} | Savora</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-height: 760px) {
            ...
            .error-breadcrumb { margin-bottom: 18px; }
            ...
            .countdown-wrap { padding: 14px; margin-bottom: 20px; }
...
<body>
    ...
    <div class="error-card">
        ...
        <h1 class="error-title">{{ $isEnglish ? 'Too Many Requests' : 'Terlalu Banyak Permintaan' }}</h1>
        <p class="error-subtitle">
            {{ $isEnglish ? 'You are moving too fast! Savora needs a short break before handling' : 'Kamu terlalu cepat! Savora perlu sedikit jeda sebelum melayani' }}<br>
            {{ $isEnglish ? 'the next request. Please wait a moment and try again.' : 'permintaan berikutnya. Tunggu sebentar lalu coba lagi.' }}
        </p>

        <div class="countdown-wrap">
            <p class="countdown-label"><i class="bi bi-hourglass-split me-1"></i> {{ $isEnglish ? 'Try again in' : 'Coba lagi dalam' }}</p>
