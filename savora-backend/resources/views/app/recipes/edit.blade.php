            ...
            <div class="rounded-3xl overflow-hidden shadow-sm border mb-4"
                ...
                <div class="relative h-44" style="background: var(--gradient-accent);">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        ...
                        <div x-show="!imagePreview && !existingImage" class="text-center" style="color: var(--color-on-accent);">
            ...
            <div class="rounded-3xl overflow-hidden shadow-sm border mb-4"
                ...
                <div class="relative h-32" style="background: var(--gradient-category);">
                    ...
                    <div class="absolute inset-0 flex items-center justify-center">
                        ...
                        <div x-show="!videoFileName && !existingVideo" class="text-center" style="color: var(--color-on-accent);">
                        ...
                        <div x-show="!videoFileName && existingVideo && !shouldRemoveVideo" class="text-center" style="color: var(--color-on-accent);">
                        ...
                        <div x-show="shouldRemoveVideo" class="text-center" style="color: var(--color-on-accent);">
            ...
            <div class="rounded-3xl w-full max-w-lg max-h-[85vh] flex flex-col shadow-2xl"
                ...
                <div class="px-4 py-3 border-b" style="border-color: var(--color-separator);" x-show="tagSearch.trim().length >= 2 && !tagSearchLoading">
                    ...
                    <button type="button"
                            ...
                            :class="selectedTags.length >= 3 ? 'cursor-not-allowed' : ''"
                            :style="selectedTags.length >= 3 ? 'color: var(--color-text-muted); background: var(--color-chip-bg);' : 'color: var(--color-primary-coral);'"

                            @mouseenter="if (selectedTags.length < 3) $el.style.background='var(--color-chip-bg)'"
                            @mouseleave="if (selectedTags.length < 3) $el.style.background='transparent'">
                ...
                <div class="flex-1 overflow-y-auto p-4 space-y-1">
                    ...
                    <template x-for="tag in modalTagList" :key="tag.id">
                        ...
                        <button type="button"
                                ...
                                :class="isTagSelected(tag.id) ? 'font-semibold' : (selectedTags.length >= 3 ? 'opacity-40 cursor-not-allowed' : '')"

                                :style="isTagSelected(tag.id) ? 'background: var(--color-primary-coral); color: var(--color-on-accent);' : 'color: var(--color-text-primary);'"
                                @mouseenter="if (!isTagSelected(tag.id) && selectedTags.length < 3) $el.style.background='var(--color-chip-bg)'"
