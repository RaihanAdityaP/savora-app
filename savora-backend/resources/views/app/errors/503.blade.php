...
<head>
    ...
    <title>503 — Dalam Pemeliharaan | Savora</title>
...
<body>
    ...
    <div class="error-card">
        ...
        <p class="error-subtitle">
            Dapur Savora sedang direnovasi! Kami sedang melakukan pembaruan<br>
            untuk pengalaman memasak yang lebih baik. Kembali lagi sebentar ya!
        </p>
        ...
        <div class="error-detail-box">
            ...
            <p>Pemeliharaan biasanya berlangsung kurang dari 30 menit. Coba kunjungi kembali halaman ini dalam beberapa saat.</p>
        </div>
