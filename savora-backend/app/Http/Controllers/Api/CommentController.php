...
class RatingController extends Controller
{
    ...
    {
        try {
            // Table name fixed: 'ratings' → 'recipe_ratings' (schema)
    ...
    {
        try {
            // Table name fixed: 'ratings' → 'recipe_ratings'
            $ratings = $this->supabase->select('recipe_ratings',
                ['rating'],
                ['recipe_id' => $recipeId]
            );
    ...
    public function store(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            // 'comment' removed — column does not exist in recipe_ratings schema
        ]);
        ...
        try {
            ...
            if (!empty($existing)) {
                // Update existing rating (comment column removed — not in schema)
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            // Only pass columns that exist in schema; comment removed
